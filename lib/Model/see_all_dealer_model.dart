class SeeAllDealerModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  SeeAllDealerModel({this.statusCode, this.isSuccess, this.data});

  SeeAllDealerModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.pagination, this.businesses});
