class SeeAllGarageModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  SeeAllGarageModel({this.statusCode, this.isSuccess, this.data});

  SeeAllGarageModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.pagination, this.garages});
