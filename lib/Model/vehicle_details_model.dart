...
class VehicleDetailsModel {
  ...
  VehicleDetailsModel({this.statusCode, this.isSuccess, this.data});
...
class Data {
  ...
  Data({this.vehicle, this.vehicleImages});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['vehicleImages'] != null) {
      ...
      json['vehicleImages'].forEach((v) {
        vehicleImages!.add(new VehicleImages.fromJson(v));
      });
      vehicleImages!.insert(0, VehicleImages(imageUrl: vehicle!.vehiclePrimaryImageUrl));
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.vehicleImages != null) {
      data['vehicleImages'] =
          this.vehicleImages!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Vehicle {
  ...
  Vehicle.fromJson(Map<String, dynamic> json) {
    ...
    whenToStart = json['whenToStart'] != ''
        ? new WhenToStart.fromJson(json['whenToStart'])
        : null:'';
    SharedPrefUtils.isLoggedIn()?
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.whenToStart != null) {
      data['whenToStart'] = this.whenToStart!.toJson();
    }
...
class VehicleImages {
  ...
  VehicleImages({this.vehicleImageId, this.imageUrl});
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['vehicleImageId'] = this.vehicleImageId;
