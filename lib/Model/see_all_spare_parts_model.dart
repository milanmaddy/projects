class SeeAllSparePartsModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  SeeAllSparePartsModel({this.statusCode, this.isSuccess, this.data});

  SeeAllSparePartsModel.fromJson(Map<String, dynamic> json) {
...
class UserColor {
  ...
  UserColor({this.background, this.userNameColor});
