class NotificationListModel {
  ...
  NotificationListModel({this.statusCode, this.isSuccess, this.data});
...
class Data {
  ...
  Data({this.pagination, this.notification});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['Notification'] != null) {
      ...
      json['Notification'].forEach((v) {
        notification!.add(new Notificationn.fromJson(v));
      });
    }
  }
...
class Notificationn {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['read_unread'] = this.readUnread;
    data['link'] = this.link;
