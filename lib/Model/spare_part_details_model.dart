...
class SparePartDetailsModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  SparePartDetailsModel({this.statusCode, this.isSuccess, this.data});

  SparePartDetailsModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.sparePart, this.sparePartImages});

  Data.fromJson(Map<String, dynamic> json) {
    sparePart = json['sparePart'] != null
        ? new SparePart.fromJson(json['sparePart'])
        : null;
    if (json['sparePartImages'] != null) {
      sparePartImages = <SparePartImages>[];
      json['sparePartImages'].forEach((v) {
        sparePartImages!.add(new SparePartImages.fromJson(v));
      });
      sparePartImages!.insert(0, SparePartImages(imageUrl: sparePart!.sparePartPrimaryImageUrl));
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sparePartImages != null) {
      data['sparePartImages'] =
          this.sparePartImages!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class SparePartImages {
  String? sparePartImageId;
  String? imageUrl;

  SparePartImages({this.sparePartImageId, this.imageUrl});

  SparePartImages.fromJson(Map<String, dynamic> json) {
    sparePartImageId = json['sparePartImageId'];
    imageUrl = json['imageUrl'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['sparePartImageId'] = this.sparePartImageId;
