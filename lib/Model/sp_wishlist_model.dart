class SPWishlistModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  SPWishlistModel({this.statusCode, this.isSuccess, this.data});

  SPWishlistModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  List<LikedSpareParts>? likedSpareParts;

  Data({this.pagination, this.likedSpareParts});

  Data.fromJson(Map<String, dynamic> json) {
    pagination = json['pagination'] != null
        ? new Pagination.fromJson(json['pagination'])
        : null;
    if (json['likedSpareParts'] != null) {
      likedSpareParts = <LikedSpareParts>[];
      json['likedSpareParts'].forEach((v) {
        likedSpareParts!.add(new LikedSpareParts.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.likedSpareParts != null) {
      data['likedSpareParts'] =
          this.likedSpareParts!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class LikedSpareParts {
  ...
  LikedSpareParts.fromJson(Map<String, dynamic> json) {
