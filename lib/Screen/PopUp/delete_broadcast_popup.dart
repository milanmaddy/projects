...
class DeleteBroadcast extends StatelessWidget {
  DeleteBroadcast({Key? key, required this.broadcastID}) : super(key: key);
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            children: [
              ...
              Text('Delete Broadcast', style: AppTextStyle.black18_700),
          ...
          const Text('Are you sure you want to delete\nthe broadcast?', textAlign: TextAlign.center,
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                Expanded(child: Buttons.popupButton(title: 'Yes', event: (){broadcastController.deleteBroadcastData(bID: broadcastID); Get.back();}))
              ],
            ),
          )
        ],
