...
class RepairGarageDetailsModel {
  int? statusCode;
  bool? isSuccess;
  Data? data;

  RepairGarageDetailsModel({this.statusCode, this.isSuccess, this.data});

  RepairGarageDetailsModel.fromJson(Map<String, dynamic> json) {
...
class Garage {
  ...
  Garage.fromJson(Map<String, dynamic> json) {
    ...
    if (json['images'] != null) {
      ...
      images!.insert(0, Images(imageUrl: garageSecondaryImageUrl!));
    }
